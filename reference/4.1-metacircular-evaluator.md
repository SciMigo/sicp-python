...
![Figure 4.1:Theeval-applycycle exposes the essence of a computer language.](figures/Fig4.1a.std.svg)
...
![Figure 4.2:The factorial program, viewed as an abstract machine.](figures/Fig4.2a.std.svg)
...
![Figure 4.3:The evaluator emulating a factorial machine.](figures/Fig4.3.std.svg)
...
satisfactory interpretation of the two `define`s is to regard them as if
