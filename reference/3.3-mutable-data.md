...
![Figure 3.12:Listsx:((a b) c d)andy:(e f).](figures/Fig3.12b.std.svg)

![Figure 3.13:Effect of(set-car! x y)on the lists inFigure 3.12.](figures/Fig3.13b.std.svg)
...
![Figure 3.14:Effect of(define z (cons y (cdr x)))on the lists inFigure 3.12.](figures/Fig3.14b.std.svg)
...
![Figure 3.15:Effect of(set-cdr! x y)on the lists inFigure 3.12.](figures/Fig3.15b.std.svg)
...
![Figure 3.16:The listz1formed by(cons x x).](figures/Fig3.16b.std.svg)
...
![Figure 3.17:The listz2formed by(cons (list 'a 'b) (list 'a 'b)).](figures/Fig3.17b.std.svg)
...
![Figure 3.18:Queue operations.](figures/Fig3.18.std.svg)
...
![Figure 3.19:Implementation of a queue as a list with front and rear pointers.](figures/Fig3.19b.std.svg)
...
![Figure 3.20:Result of using(insert-queue! q 'd)on the queue ofFigure 3.19.](figures/Fig3.20c.std.svg)
...
![Figure 3.21:Result of using(delete-queue! q)on the queue ofFigure 3.20.](figures/Fig3.21c.std.svg)
...
are glued together to form a list by pairs whose `car`s point to
...
![Figure 3.22:A table represented as a headed list.](figures/Fig3.22c.std.svg)
...
form a new record by `cons`ing the key with the value, and insert this at
...
![Figure 3.23:A two-dimensional table.](figures/Fig3.23b.std.svg)
...
![Figure 3.24:Primitive functions in the digital logic simulator.](figures/Fig3.24a.std.svg)
...
![Figure 3.25:A half-adder circuit.](figures/Fig3.25c.std.svg)
...
![Figure 3.26:A full-adder circuit.](figures/Fig3.26.std.svg)
...
![Figure 3.27:A ripple-carry adder forn-bit numbers.](figures/Fig3.27b.std.svg)
...
![Figure 3.28:The relation9C=5(F−32)expressed as a constraint network.](figures/Fig3.28.std.svg)
