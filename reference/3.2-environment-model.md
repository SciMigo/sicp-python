...
![Figure 3.1:A simple environment structure.](figures/Fig3.1b.std.svg)
...
![Figure 3.2:Environment structure produced by evaluating(define (square x) (* x x))in the global environment.](figures/Fig3.2b.std.svg)
...
![Figure 3.3:Environment created by evaluating(square 5)in the global environment.](figures/Fig3.3b.std.svg)
...
![Figure 3.4:Procedure objects in the global frame.](figures/Fig3.4b.std.svg)
...
![Figure 3.5:Environments created by evaluating(f 5)usingthe procedures inFigure 3.4.](figures/Fig3.5b.std.svg)
...
![Figure 3.6:Result of definingmake-withdrawin the global environment.](figures/Fig3.6c.std.svg)
...
![Figure 3.7:Result of evaluating(define W1 (make-withdraw 100)).](figures/Fig3.7b.std.svg)
...
![Figure 3.8:Environments created by applying the procedure objectW1.](figures/Fig3.8c.std.svg)
...
![Figure 3.9:Environments after the call toW1.](figures/Fig3.9b.std.svg)
...
![Figure 3.10:Using(define W2 (make-withdraw 100))to create a second object.](figures/Fig3.10b.std.svg)
...
![Figure 3.11:Sqrtprocedure with internal definitions.](figures/Fig3.11b.std.svg)
