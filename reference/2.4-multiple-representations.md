...
![Figure 2.19:Data-abstraction barriers in the complex-number system.](figures/Fig2.19a.std.svg)
...
![Figure 2.20:Complex numbers as points in the plane.](figures/Fig2.20.std.svg)
...
$$\begin{array}{lll}
\text{Magnitude}(z_{1} ⋅ z_{2}) & = & \text{Magnitude}(z_{1}) ⋅ \text{Magnitude}(z_{2}), \\
\text{Angle}(z_{1} ⋅ z_{2}) & = & \text{Angle}(z_{1}) + \text{Angle}(z_{2}).
\end{array}$$
...
![Figure 2.21:Structure of the generic complex-arithmetic system.](figures/Fig2.21a.std.svg)
...
![Figure 2.22:Table of operations for the complex-number system.](figures/Fig2.22.std.svg)
